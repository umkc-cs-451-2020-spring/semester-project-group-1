...
public class StateTriggerDao extends BaseDao{
     ...
     */
    public List<StateTriggerDomain> getAllAppBuilds() {
	 ...
	 */
	public ResponseEntity<Object> updateBuildEntry(StateTriggerDomain inputTrigger) {
     ...
     */
    public ResponseEntity<Object> deleteBuild(int triggerID, int userID) {
